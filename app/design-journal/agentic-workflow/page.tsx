        ...
        <div className="container">
          <div className={styles.outcomeGrid}>
              ...
              <div className={styles.outcomeRight}>
                <div className={styles.challengeBody} style={{ marginTop: 0 }}>
                  <p>
                ...
                <span className={styles.sectionLabel} style={{ marginTop: '32px' }}>Tools &amp; Logic</span>
                <div className={styles.methodsGrid} style={{ marginTop: '24px' }}>
